function allBenchSP(imgDir, gtDir, inDir, outDir, nthresh, maxDist, thinpb)
...
% Updated by David Stutz <david.stutz@rwth-aachen.de>
    ...
    for i = 1:numel(iids),
        ...
        evaluation_bdry_imageSP(inFile,gtFile, evFile1, nthresh, maxDist, thinpb);
        evaluation_reg_imageSP(inFile, gtFile, evFile2, evFile3, evFile4, nthresh);
    end
