function [thresh, cntR, sumR, cntP, sumP, cntR_best] = evaluation_reg_image2(inFile, gtFile, evFile2, evFile3, evFile4, nthresh)
...
%         sumVOI(t) = voi;
        ...
        % the segmentation
%         num = numel(regionsGT);
%          nummatchesSeg = numel(matchesSeg);
%          nummatchesGT = numel(matchesGT);
