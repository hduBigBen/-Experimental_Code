function [thresh, cntR, sumR, cntP, sumP, cntR_best] = evaluation_reg_image1(inFile, gtFile, evFile2, nthresh)
...
% Updated by David Stutz <david.stutz@rwth-aachen.de>
    ...
    for s = 1 : nsegs
        ...
        % the number of pixels of every region
    ...
    for t = 1 : nthresh
        ...
        [matches] = match_segmentations(Segmentation, groundTruth);
        ...
        regionsSeg = regionprops(Segmentation, 'Area');
        % cntP/sumP will be the covering of the segmentation by the ground
        % truth segmentationmatch_segmentations2
